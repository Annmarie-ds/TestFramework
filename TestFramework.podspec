...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Annmarie-ds" => "annmarie.desilva@carsales.com" }
  # Or just: spec.author    = "Annmarie-ds"
  # spec.authors            = { "Annmarie-ds" => "annmarie.desilva@placie.com" }
  # spec.social_media_url   = "https://twitter.com/Annmarie-ds"
